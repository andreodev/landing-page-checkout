    ...
    return (
        <section className="bg-[#FAFAFA] flex flex-col items-center justify-start my-15 sm:my-24 px-4 sm:px-0">
            <div className="grid grid-cols-1 md:grid-cols-2 w-full max-w-7xl items-stretch rounded-2xl bg-white">
                ...
                <div className="flex flex-col justify-center items-center space-y-6 px-4 py-8 md:py-0">

                    <div className='text-[#3B4781] text-3xl sm:text-4xl md:text-5xl text-center font-medium md:mt-8'>
                        <span className='block'>Aumento médio </span>
                        <span className='block'>de 40% na conversão</span>
                    </div>

                    <div 
                        className='text-lg sm:text-xl md:text-[26px] font-medium text-center py-2.5 px-4 rounded-lg max-w-full'
                        style={{
                    ...
                    >
                        <p className="flex items-center justify-center gap-1 flex-wrap"><CartIcon /> <span>dos</span><span className='text-[#01AEA4]'>carrinhos abandonados</span></p>
                    </div>

                </div>

                <div className="flex items-center justify-center md:justify-end px-4 py-8 md:py-0">
